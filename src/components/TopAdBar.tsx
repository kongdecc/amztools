...
const TOP_AD_TEXT = String(process.env.NEXT_PUBLIC_TOP_AD_TEXT || '跨境乐趣园：卖家讨论群日报，海量运营干货名免费下载，欢迎查看使用。')
  ...
  return (
    <div className="w-full border-y border-orange-200 bg-orange-50">
      <div className="mx-auto flex h-10 max-w-screen-2xl items-center justify-center px-3 text-xs text-orange-700 md:text-sm">
        <a href={TOP_AD_LINK || '#'} target="_blank" rel="noopener noreferrer" className="flex w-full items-center justify-center gap-2 overflow-hidden">
