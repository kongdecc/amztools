...
export const DEFAULT_TOOLS = [
  ...
  { key: 'amazon-category-selection-center', title: 'Amazon类目选品管理中心', desc: '聚合 Amazon Browse Tree Guide 分类树、叶子清单和评估进度，辅助类目筛选与选品管理', status: '启用', views: 0, color: 'indigo', order: 17, category: 'operation', href: '/amazon-category-selection-center', isExternal: true },
