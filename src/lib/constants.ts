...
export const DEFAULT_CATEGORIES = [
  ...
  { key: 'keyword-traffic', label: '关键词与流量', enabled: true, order: 2 },
...
export const DEFAULT_TOOLS = [
  ...
  { key: 'amazon-ads-analyzer', title: '亚马逊广告分析工具', desc: '可视化分析亚马逊广告报表，支持多维度KPI分析、散点图趋势和搜索词优化建议', status: '启用', views: 0, color: 'blue', order: 3, category: 'advertising', href: '/amazon-ads-analyzer/index.html', isExternal: true },
  { key: 'amazon-bulk-ads-tool', title: '亚马逊广告批量处理工具', desc: '广告 Bulk 表批量创建、导入、更新和导出，纯前端处理不上传数据', status: '启用', views: 0, color: 'blue', order: 3.5, category: 'advertising', href: '/bulk/index.html', isExternal: true },

  { key: 'sqp-lens', title: 'SQP 搜索查询绩效分析', desc: '批量导入 Amazon SQP 品牌或 ASIN 视图 CSV，分析搜索趋势、漏斗份额与关键词运营机会', status: '启用', views: 0, color: 'emerald', order: 101, category: 'keyword-traffic', href: '/sqp/index.html', isExternal: true },
  { key: 'keyword-combiner', title: '关键词组合工具', desc: '多维度关键词组合，支持去重和多种分隔符', status: '启用', views: 0, color: 'blue', order: 102, category: 'keyword-traffic' },
  { key: 'keyword-strategy', title: '关键词策略工具', desc: '分析关键词分布，制定Listing埋词策略', status: '启用', views: 0, color: 'indigo', order: 103, category: 'keyword-traffic' },
  { key: 'search-term-volatility', title: '搜索词波动分析', desc: '对比分析多份CSV报告，快速识别ABA排名、点击份额和转化份额波动较大的搜索词', status: '启用', views: 0, color: 'purple', order: 104, category: 'keyword-traffic' },
  { key: 'natural-traffic-tool', title: '自然流量分析工具', desc: '分析自然流量与广告流量占比，优化流量结构', status: '启用', views: 0, color: 'blue', order: 105, category: 'keyword-traffic' },
  { key: 'amazon-global', title: '亚马逊批量查询', desc: '关键词排名监控与ASIN全球跟卖侦查，支持多站点一键打开', status: '启用', views: 0, color: 'orange', order: 106, category: 'keyword-traffic' },

  { key: 'listing-check', title: 'Listing自检工具（新规）', desc: '标题/五点/ST/长描述合规与关键词埋入检查，含2026标题与商品亮点新规自检', status: '启用', views: 0, color: 'teal', order: 201, category: 'listing-operation' },
  { key: 'forbidden-words', title: '亚马逊文案违禁词检测', desc: '检测亚马逊文案中的违禁词，支持自定义词库和批量替换', status: '启用', views: 0, color: 'red', order: 202, category: 'listing-operation' },
  { key: 'amazon-category-selection-center', title: 'Amazon类目选品管理中心', desc: '聚合 Amazon Browse Tree Guide 分类树、叶子清单和评估进度，辅助类目筛选与选品管理', status: '启用', views: 0, color: 'indigo', order: 203, category: 'listing-operation', href: '/amazon-category-selection-center.html', isExternal: true },
  { key: 'amazon-promotion-stacking', title: '亚马逊促销叠加计算器', desc: '自动计算促销叠加或互斥，基于2025版《各类促销叠加情况》矩阵表逻辑', status: '启用', views: 0, color: 'blue', order: 204, category: 'listing-operation' },
  { key: 'returns-v2', title: '退货报告分析V2', desc: '上传退货报告，原因/趋势/仓库/评论多维分析', status: '启用', views: 0, color: 'red', order: 205, category: 'listing-operation' },
  { key: 'rating-sales-reverse', title: '亚马逊评分销量反推', desc: 'Listing 补单计算 + 销量反推 (支持自定义留评率)', status: '启用', views: 0, color: 'indigo', order: 206, category: 'listing-operation' },

  { key: 'freight-rate-radar', title: '\u5934\u7a0b\u6bd4\u4ef7\u5de5\u5177', desc: '\u4e0a\u4f20\u8d27\u4ee3 Excel \u62a5\u4ef7\u8868\uff0c\u6309 FBA \u4ed3\u5e93\u3001\u91cd\u91cf\u3001\u7a0e\u522b\u548c\u65f6\u6548\u5feb\u901f\u7b5b\u9009\u6700\u4f4e\u5934\u7a0b\u62a5\u4ef7', status: '\u542f\u7528', views: 0, color: 'teal', order: 301, category: 'shipping-logistics', href: '/freight-rate-radar/index.html', isExternal: true },
  { key: 'freight-invoice-studio', title: '货代发票工作台', desc: '维护产品资料与货代模板，支持字段映射、Excel 预览编辑、导出历史和完整备份恢复', status: '启用', views: 0, color: 'indigo', order: 302, category: 'shipping-logistics', href: '/freight-invoice/index.html', isExternal: true },
  { key: 'amazon-label-sorter', title: 'Amazon 箱唛按 SKU 归集工具', desc: '把多个 FBA / AWD 标签 PDF 按 SKU 跨仓归集，生成独立 PDF 并打包下载，全程在浏览器本地处理', status: '启用', views: 0, color: 'orange', order: 303, category: 'shipping-logistics', href: '/amazon-label-sorter/index.html', isExternal: true },
  { key: 'fba-label-editor', title: 'FBA标签编辑器', desc: '在线编辑FBA标签PDF，支持添加文字（如批量添加Made in China)、手动拖拽调整位置和大小，自动应用到所有页面', status: '启用', views: 0, color: 'red', order: 304, category: 'shipping-logistics' },
  { key: 'fba-warehouses', title: 'FBA仓库查询', desc: '查询FBA仓库地址、邮编等信息，支持国家、地区筛选和偏远地区查询', status: '启用', views: 0, color: 'indigo', order: 305, category: 'shipping-logistics' },

  { key: 'delivery', title: '美国站配送费计算', desc: '按2025/2026规则计算配送费用', status: '启用', views: 0, color: 'orange', order: 401, category: 'fees-inventory' },
  { key: 'amazon-jp-fba-calculator', title: '亚马逊 JP 站点 FBA 配送费计算器', desc: '根据商品尺寸、重量、售价与冷冻附加费规则，估算日本站 FBA 配送费用', status: '启用', views: 0, color: 'orange', order: 402, category: 'fees-inventory' },
  { key: 'amazon-eu-fba-calculator', title: 'Amazon EU FBA 费用计算器', desc: '欧洲站配送费/仓储费/弃置退仓/多站点对比的一体化计算', status: '启用', views: 0, color: 'orange', order: 403, category: 'fees-inventory' },
  { key: 'amazon-fee-visualizer', title: '亚马逊费用可视化查询', desc: '按费用类型查询亚马逊 FBA 配送费、仓储费及其他费用，支持尺寸、重量与计费条件筛选', status: '启用', views: 0, color: 'blue', order: 404, category: 'fees-inventory', href: '/amazon-fee-visualizer/index.html', isExternal: true },
